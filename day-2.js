...
state.name = "Chris";
state.email = "chrisdafur@gmail.com";
state.zipCode = 70117;
console.log("State:", state);
console.table(state);
...
state.age = 49;
state.phoneNumber = "951-0481";
state.address = "2530 Burgundy st., New Orleans";
...
state.favoriteMovies = ["The Fountain", "Annihilation", "Under the Skin"];
...
state.recentPurchases = [12,54,32,54];

console.log("State:", state);
console.table(state.recentPurchases);

for (let i = 0; i < state.recentPurchases.length; i++) {
  console.log(`Purchase ${i +1}:`, state.recentPurchases[i]);
...
state.hobbies = ["Art", "Games", "Reading"];
