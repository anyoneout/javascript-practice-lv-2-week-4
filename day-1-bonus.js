...
let bookCollection = [];
bookCollection.push(createBook("Ringworld", "Larry Niven"));
bookCollection.push(createBook("Dune Messiah", "Frank Herbert"));
bookCollection.push(createBook("Unbearable Lightness of Being", "Milan Kundera"));
...
taskList.push(createTask("Walk the dog", "2024-08-23"));
taskList.push(createTask("Eat a cake", "2024-08-27"));
taskList.push(createTask("Smell the roses", "2024-09-23"));
...
library.push(createBook("Foundation", "Isaac Asimov"));
library.push(createBook("The Hobbit", "JRR Tolkien"));
library.push(createBook("At the Mountains of Madness", "H.P. Lovecraft"));
...
taskList3.push(createTask("Walk the roses", "2024-08-24"));
taskList3.push(createTask("Smell the dog", "2024-09-14"));
taskList3.push(createTask("Walk the plants", "2024-09-02"));
